...
const items = [
    ...
    { name: "Tilta Nucleus Nano FIZ" , keywords: "nucleus-n nuclaus-n tilte tilta tiltanucleus-n mano namo nano mamo følge tilta fokus nucleus-m nucleus-n nuclaus-n tilte tilta tiltanucleus-n tilta nucleus-n follow focus followfocus fiz" , url: "html/nano.html" },
