...
const items = [
    ...
    { name: "HDMI Coil 50CM" , keywords: "hdmi cable coil 50cm flexible hdmy mispell short hdmi coilcable", url: "html/hdmistraight.html" },
    { name: "HDMI to HDMI Mini" , keywords: "hdmi mini cable minihdmi adapter converter hdmimini mispelling", url: "html/hdmi-mini.html" },
    { name: "HDMI Angle Adapter" , keywords: "hdmi angle angled adaptor corner convert hdmy mispelling", url: "html/hdmiadapt.html" },
    ...
    { name: "Røde NTG3B" , keywords: "rode mic rod ntg3 ntg3b shotgun roede microphone mispelling", url: "html/ntg3.html" },
    { name: "Lavalier Belt" , keywords: "lav belt laavalier mic waist strap microphone holder bodypack", url: "html/lavbelt.html" },
    { name: "Baby Pin Spigot with 5/8\" Hex Stud" , keywords: "baby pin spiggott 5/8 spigot hex styd mount lighting bracket mispelling", url: "html/hexspig.html" },
    ...
    { name: "Safety Wire" , keywords: "safety wire saftey wir security cable rigging steel mispelling", url: "html/safetywire.html" },
    ...
    { name: "Eyebolt 1/4 Thread" , keywords: "eye bolt 1 4 thread rigging anchor eyelet eey bolt mispell hardware", url: "html/eye1.4.html" },
    { name: "Eyebolt 3/8 Thread" , keywords: "eye bolt 3 8 thread rigging anchor eyelet eey bolt misl hardware", url: "html/eye3.8.html" },
    { name: "Wedge Set" , keywords: "wedge set wood plastic leveling doorstop shims widg wedge mispell", url: "html/wedge.html" },
    { name: "Zhiyun Smooth X" , keywords: "zhiyun zhyun phone gimbal smooth x smootx stabilizer zhijin mispell", url: "html/cellgimbal.html" },
    { name: "15mm Rods" , keywords: "15mm rods rod rails cinema rig pipeline fifteem mispell rod set", url: "html/15mmrod.html" },
    { name: "19mm Rods" , keywords: "19mm rods rod rails cinema rig pipeline ninteen mispell rod set", url: "html/19mmrod.html" },
